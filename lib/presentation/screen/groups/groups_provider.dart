...
class GroupsProvider extends ChangeNotifier {
  List<GuideModelDomain> listGroup = List<GuideModelDomain>();
  ...
  void firstCallData(GuideModelDomain groupData) {
    this.mapData = groupData;
    if (listGroup.length == 0 && !loadingMore) {
      getListMap();
    }
  }
  ...
  void getListMap() async {
    ...
    if (response != null && response.statusCode == 200) {
      ...
      listData.forEach((element) {
        listGroup.add(GuideModelDomain.fromData(
            id: element.id,
