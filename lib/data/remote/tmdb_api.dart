...
class TMDBApi {
  ...
  Future<void> init() async {
    print("init tmdb");
    _http = Request(ServerConfig.instance.theMovieDBHostV3);
    _httpV4 = Request(ServerConfig.instance.theMovieDBHostV4);
    _apikey = ServerConfig.instance.theMovieDBApiKeyV3;
    _apikeyV4 = ServerConfig.instance.theMovieDBApiKeyV4;
